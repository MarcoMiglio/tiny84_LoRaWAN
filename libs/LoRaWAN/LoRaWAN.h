...
class LoRaWAN
{
  public:
    ...
    void Send_Data(unsigned char *Data, unsigned char Data_Length, unsigned int Frame_Counter_Tx, uint8_t SF);
  ...
  private:
    ...
    // MODIFICA: variabile "uint8_t SF" dell func. Send_Package
